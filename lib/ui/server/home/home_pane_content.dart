...
import 'package:quiz/ui/server/home/widgets/answer_content/answers_content.dart';
...
class HomePaneContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    else if (homeVm.state == HomeState.answer) {
      return ChangeNotifierProvider.value(value: homeVm.answersVM, child: const AnswersContent());
    }
